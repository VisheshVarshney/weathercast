    ...
    .then(data => {
        ...
        data.weather.forEach(item => {
            ...
            if (item.id < 250) {
                ...
                document.getElementById('container').style.backgroundImage = `url('https://source.unsplash.com/1600x900/?drizze')`;
            } else if (item.id < 550) {
                ...
                document.getElementById('container').style.backgroundImage = `url('https://source.unsplash.com/1600x900/?clearky')`;
            } else if (item.id === 800) {
